...
def run_alignment(
    ...
    recall_path = (
        ...
        / RECALL_SUBDIR
        / story_name
        / RECALL_PATTERN.format(participant=participant_number, story=story_name)
    )
    ...
    if other_participant_number is not None:
        other_recall_path = (
            ...
            / RECALL_SUBDIR
            / story_name
            / RECALL_PATTERN.format(
                participant=other_participant_number,
                story=story_name,
            )
        )
...
def run_all(
    ...
    if story_name is None and participant_number is None:
        ...
        for recall_dir in recall_dirs:
            ...
            for f in recall_dir.glob("P*.txt"):
                name = f.stem
    ...
    # -------- CASE 2: one story, all its participants --------
        ...
        recall_dir = recall_root / story_name
